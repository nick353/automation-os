...
-- Official, company-scoped source of truth for the one-candidate job
-- application admission. Raw resume/payload contents and credentials never
-- belong here; only immutable references and hashes are accepted.
