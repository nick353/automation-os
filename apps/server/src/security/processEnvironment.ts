...
const workerEnvironmentKeys = new Set([
  ...
  "AUTOMATION_OS_WORKER_DURABLE_ONLY",
  "AUTOMATION_OS_WORKER_ROLE",
  "AUTOMATION_OS_DURABLE_SERVICE_USER_ID",
  "CODEX_CLI_PATH",
  "AUTOMATION_OS_ASSUME_EXISTING_POSTGRES_SCHEMA",
  "AUTOMATION_OS_POSTGRES_SCHEMA_ASSUMED_CURRENT",
  ...
  // A run-bound Browser Use flow may explicitly bind the installed helper or
  // a source helper generation. Keep this opt-in and allowlisted so the
  // portable business runner cannot silently inherit arbitrary executables.
  ...
  "AUTOMATION_OS_BROWSER_GOAL_ID",
  "AUTOMATION_OS_BROWSER_GOAL_STATE_PATH",
  "AUTOMATION_OS_BROWSER_GOAL_TERMINAL",
  "AUTOMATION_OS_BROWSER_GOAL_RECOVERY_BUDGET",
  // A bounded local Companion worker must carry only its explicit, run-owned
  // installation and transport paths into both launcher layers.  These are
  // paths, not credentials; the corresponding files remain owner-scoped.
  ...
  "AOS_CHROME_COMPANION_TASK_ID",
  "AOS_CHROME_COMPANION_REQUIRE_ISOLATED_PATHS",
  "AOS_CHROME_COMPANION_ISOLATION_BINDING_PATH",
  "AOS_CHROME_COMPANION_ISOLATION_BINDING_SHA256",
  "AOS_DAILY_AI_INJECT_COMMIT_FAILURE_ONCE",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_RUNNER",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_DEFAULT_RUNNER",
  "AUTOMATION_OS_PORTABLE_BUSINESS_RUNNER_JOB_APPLICATION",
  "AUTOMATION_OS_PORTABLE_BUSINESS_RUNNER_DAILY_AI",
  "AUTOMATION_OS_PORTABLE_BUSINESS_RUNNER_NISENPRINTS",
  "AUTOMATION_OS_PORTABLE_BUSINESS_NO_LAUNCH",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_INPUT_BUNDLE_PATH",
  "AUTOMATION_OS_PORTABLE_WEB_OPERATION_INTENT_PATH",
  "AUTOMATION_OS_PORTABLE_WEB_OPERATION_INTENT_SHA256",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_READ_ONLY_STAGE",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_WORKDIR",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_TIMEOUT_MS",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_EFFECTS",
  "DAILY_AI_QUEUE_PATH",
  "AUTOMATION_OS_PORTABLE_WORKER_MODE",
  "AUTOMATION_OS_PORTABLE_EXTERNAL_CODEX_TIMEOUT_MS",
  "AUTOMATION_OS_WEB_OPERATION_CONTRACT_SCHEMA",
  "AUTOMATION_OS_WEB_OPERATION_ADAPTIVE"
]);
